...
class Irregular{
    ...
    { 
        $irregularVerb = $this->db->query("SELECT * FROM irregular ORDER BY rand() LIMIT $limit;");
        return $irregularVerb;
    }


    public function getComparador($id)
    {
        $resVerbo = $this->db->query("SELECT prensent_tense, past_tense, past_participe FROM irregular WHERE id = $id;");
        return $resVerbo;
